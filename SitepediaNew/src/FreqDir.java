...
public class FreqDir {
	WebDriver driver;
	
	public FreqDir(WebDriver driver)
	{
		this.driver=driver;
	}
	
	public void createFreq(String new_freq_text)
	{
		WebElement wait = (new WebDriverWait(driver, 10)).until(ExpectedConditions.presenceOfElementLocated(By.linkText("�����")));
		driver.get("http://92.242.32.232:8133/#/administration/catalogs/freqperiod");
	...
	public boolean findFreq(String new_freq_text)
	{
	...
	public void delFreq(String new_freq_text)
	{
		 driver.get("http://92.242.32.232:8133/#/administration/catalogs/freqperiod");
	...
	public boolean enterFindFreq(String freqName1, String freqName2)
	{
		driver.get("http://92.242.32.232:8133/#/administration/catalogs/freqperiod");
	...
	public String editFreq(String freq)
	{
		driver.get("http://92.242.32.232:8133/#/administration/catalogs/freqperiod");
